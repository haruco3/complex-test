...
?>
<div id="mainbox">
<p>The modulus of a complex number is given by arctan(<sup> y</sup>&frasl;<sub>x </sub>). The argument of a complex number is given by &radic;<span class="sqrt">x<sup>2</sup> + y<sup>2</sup></span></p>
<br />
<p>The modulus-argument form of a complex number is r[cos(α) + sin(α)] where r = the modulus and α = the argument.</p>
<br />
